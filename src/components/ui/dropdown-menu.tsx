...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-[60] min-w-[8rem] rounded-md border bg-popover p-1 text-popover-foreground shadow-lg will-change-[opacity,transform]",
  ...
  <DropdownMenuPrimitive.Portal>
    <div className="relative z-[60]">
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "min-w-[8rem] rounded-md border bg-popover p-1 text-popover-foreground shadow-md will-change-[opacity,transform]",
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          className
        )}
        {...props}
